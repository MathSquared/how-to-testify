...
You can affect state legislative proceedings in many of the same ways you can affect national legislation, such as by calling or writing your legislator, or just voting in elections. But this guide will cover another important way to act: by testifying.

First, a little bit about me. I'm a student at the University of Texas at Austin, majoring in Computer Science. My first time testifying was on Thursday, February 2, 2017, when I testified against [SB 4](http://www.legis.state.tx.us/BillLookup/History.aspx?LegSess=85R&Bill=SB4), a bill to defund sanctuary cities. Since then, I've testified at five other hearings at the Texas Legislature on topics from LGBT rights to college sexual assault. I also have years of competitive speaking experience. I've drawn this guide from the knowledge I've gained by testifying myself, as well as information I gathered from the Internet and from my personal network as I prepared to testify.

Almost every bill that passes through the Texas Legislature goes through a **committee**. The committees are small groups of legislators that specialize in a particular issue area; for instance, the aforementioned SB 4 went before the Senate State Affairs Committee. Committees hold **hearings** to consider a bill. Most hearings will invite **public testimony**, where anyone can speak directly to the committee in support of or opposition to the bill. SB 4 was particularly controversial, drawing hundreds of people to the Capitol to testify. But most hearings&mdash;even on extremely important legislation&mdash;only have a few witnesses, usually from major lobbying groups or think tanks. I'm hoping to change that, because testimony is a great way to alter the course of the Texas Legislature.
...
- The **time and room** of the hearing. All hearings are at the Texas Capitol, and usually start in the morning, but may be in different hearing rooms or start at different times. Some hearings start "upon adjournment", meaning when the House or Senate wraps up for the day. This is unpredictable, but you can get an idea by seeing when the House and Senate will be convening (in the corner of TLO).
...
- The **time limit** on oral testimony. This is usually three minutes, but may be shorter for high-profile hearings. If it doesn't say, assume three minutes. Also note that the committee may occasionally vote to shorten the limit.
- The **number of copies** to bring for written testimony. If this number isn't given, assume it's equal to the number of members of the committee (Googling the committee name should show you a list).
...
- One fairly common type of amendment is a **committee substitute**. That's a replacement for the bill text that a legislator drafts and then presents on the day of the hearing. These don't show up on TLO, but the sponsor will explain any changes from the original bill text in the hearing. You might also see news articles about committee substitutes, or&mdash;if you've got a lot of time on your hands&mdash;be able to get its text from the Capitol. office of the bill author, committee chair, or committee clerk.
...
Second, the TLO page should contain a non-partisan **analysis** of the bill. This usually restates the bill's legalese in slightly-beautified but nearly-identical legalese, but it's still not a bad idea to look it over. The analysis also contains a statement of rationale for the bill written by its author or sponsor, which can help inform your testimony. At the bottom of the TLO page, there might be a link to an **HRO analysis**. These are published by the House Research Organization and are very good, but usually only appear right before a bill is considered on the House floor&mdash;not in committee.

Third, many bills come with **fiscal notes** that outline any costs to the state. These are usually posted on TLO before a committee hearing. The Texas Legislature absolutely hates spending money, so make sure you consider the fiscal note in your arguments.

Fourth, if you'd like, learn the **members of the committee** and look at their portraits. This isn't strictly necessary, since all members have name placards, but it's still useful. Take special note of the chair and vice chair, who I'll discuss later. This can help you refer to legislators by name during the hearing, both when answering a question they pose and when discussing something they said earlier. (Another approach is to just listen to what the chair calls them during the hearing&mdash;still, you should at least know the names of the committee members, so that you can match the name you hear to a member.)
...
I used to write long, formal papers as written testimony, usually around five pages. Later, however, I realized nobody at the Capitol has time to read that (or thinks they do). Now, if you're giving objective testimony, I recommend you write a **onepager**, a (not surprisingly) one-page-long document outlining your policy position. (I usually add a bibliography and any extra information on the back.) I've found I could fit about as much information into my onepagers as my long packets just by reducing font size and margins. If you're giving narrative testimony, I still think a writeup of your story is best.

Make sure you print the **right number of copies**, which will be listed in the hearing notice (if it doesn't say, print a copy for each committee member, plus a couple extra for any other legislators present). You'll probably want to go to a print shop.

I've uploaded my SB 4 written testimony packet as `sample-testimony.pdf` in this repository. If you're viewing this on the Web, you can view the [Web-hosted version](https://github.com/MathSquared/how-to-testify/blob/master/sample-testimony.pdf).

I've also added my onepager on SB 576 as `sample-onepager.pdf` in this repository ([Web link](https://github.com/MathSquared/how-to-testify/blob/master/sample-onepager.pdf)).
...
Objective oral testimony should simply **summarize** your position. A detailed exposition is what your written testimony is for. Give the legislators enough information to know what your views are, but defer most of the specifics to the paper or onepager. Also, you'll need to **select your arguments**; you'll only be able to present two or maybe three at most, so pick the ones that (a) are most powerful and (b) haven't already been said in the hearing, or need additional support based on the arguments that others have made.
...
In large hearings, **be flexible**. Someone will say one of your arguments, or make an argument of their own that you just have to refute. Don't be caught up in a plan for which arguments you present or how you frame your story. At the SB 4 hearing, I had three specific plans written on paper for which arguments I would select, but by the time I got to speak I had scrapped them all and formed a new one in my head. Months later, after I had a few hearings under my belt, I got used to planning out my testimony in my head during the hearings. That approach is certainly not for everyone, but if it works for you, go ahead.

Finally, if you can, be sure to **practice** your testimony, multiple times, with a timer running. This does two things: it helps calm your nerves (because you're not delivering your testimony for the first time in the hearing room), and it makes sure you don't go overtime. Note that you'll have a timer, and committee chairs will let you finish your sentence when time runs out, but you want to make sure you can make all your points in the allotted time. As you gain experience, you'll develop an intuition for how much you can fit into your testimony, so you'll need to make fewer time-related adjustments.
...
- Appropriate **attire**. The minimum you should wear is a nice top (button-up for men) and dark, non-distressed, non-ripped jeans. Many witnesses wear some form of business casual. Some people wear a suit (with a business-appropriate tie for men). Some who are attending as part of a large group wear a T-shirt related to their cause (though I don't recommend wearing a T-shirt to testify). I personally wear a suit and tie whenever I testify orally, and recommend that you do the same if possible, especially at smaller hearings; however, suits are not required, as long as your attire shows respect for the committee.
...
The Capitol opens at 7:00a on weekdays. For hearings that are early and large, you'll want to arrive around an hour before the hearing starts, but after 7:00a. For less controversial hearings, or those that start a bit later in the day, you can show up a bit closer to the hearing start time, because there won't be as many people registering.
...
- **Walking** from the UT campus: walk south four blocks from MLK. The most centrally-aligned street to the Capitol is Congress Ave, located immediately south of the Blanton, which is itself south of Speedway. There's currently construction at the south end of Speedway, though, so you'll have to go around. You can walk south on University (the street that intersects with 21st in front of the Littlefield Fountain), turn left on MLK and then right on Congress; or you can cut through the UTC breezeway or behind the PCL, then walk to the intersection of MLK and Congress.
...
For rooms in the Capitol proper, the first digit is the floor (G, 1, 2, 3, or 4), the second is the wing (N, S, E, or W), and later digits denote the room. Elevators are just behind the security checkpoints at all four entrances; there are also restrooms near the North Wing elevators. There are large staircases immediately east and west of the Capitol rotunda that access floors 1&ndash;4, and behind the staircases on floor 1 is access to a staircase to floor G. There are also staircases to floors G&ndash;3 at the east and west ends of the building.
...
Some hearings are in other buildings in the Capitol complex, such as SHB or JHR. These are usually accessible via tunnels from E1, or you can walk in from above ground. Refer to this [above-ground map](http://www.austintexas.gov/edims/document.cfm?id=171490) of the entire Capitol complex, and the floor plan linked earlier.
...
The first thing you should do when you arrive is register. You can do this at the kiosks distributed throughout the Extension levels. Here are maps of [House kiosks on E1](https://www.mytxlegis.legis.state.tx.us/hwrspublic/images/extension1Map.jpg) and [House kiosks on E2](https://www.mytxlegis.legis.state.tx.us/hwrspublic/images/extension2Map.jpg). Senate kiosks are located on E1, on the opposite side from where the House kiosks are.

At hearings in the House and Senate Chambers, there will be kiosks stationed outside the second floor entrance to the chamber. Beware, though&mdash;lines can get very long.
...
At some hearings, the kiosks will be broken or disabled, and you'll have to fill out a card instead. In this case, you must fill out one card per bill on which you wish to testify.
...
A committee hearing involves a lot of different people. You should know who everyone is.
...
When you walk in, you may sit anywhere in the audience area (except that the first couple of rows may be reserved). Additionally, if you're submitting written but not oral testimony, give it to the assistant clerk. (If you're submitting both kinds of testimony, you'll give your written testimony to the assistant clerk when you are called to testify orally.)
...
Committee hearings are steeped in parliamentary procedure. Any **interruptions** from the audience, including applause or laughter, are generally prohibited (though a few chuckles at a good line from a legislator or witness are probably fine). The chair will tap the gavel to ask the audience to quiet down, and has the authority to kick everyone out of the room if needed. Also, be aware that interruptions slow down the hearing, because the chair has to wait for the interruption to stop before proceeding.
...
The chair will start the hearing by announcing, "The *committee name* Committee will come to order. The clerk will call the roll." (Some chairs, especially in the Senate, will also have gavels.) The clerk will then quickly take attendance.

Sometimes, the chair will make a statement at this point welcoming witnesses and explaining the flow of the hearing (when they expect the hearing to end, what order they'll consider bills in, if they'll consider multiple bills at once or each one separately, and so on).

At this point, the business of the committee will begin. They might have leftover items to consider from previous hearings; for instance, at the SB 4 hearing, the committee started by voting up several bills that were considered the previous day. After that, they'll move to the bills they're considering at this hearing, possibly out of order and occasionally several at a time.

Consideration of each bill proceeds as follows:

1. **Opening statements**, at least one by the bill's author or sponsor (known as the **layout** or **laying out** the bill), and possibly others. Any legislator present may question speakers during these statements. The author may also discuss a committee substitute, which is a modified version of the bill that the committee creates. The committee substitute usually isn't posted on TLO until after the hearing, so listen closely to this part of the opening statement.
2. **Invited testimony** by witnesses hand-picked by the committee.
3. **Public testimony**, which is when you'll be called.
4. Possibly a **vote** on the bill (though usually the committee will leave the bill pending and vote at a later hearing).

If the House or Senate is meeting on the day of the hearing, the committee will almost always need to pause the hearing during that time. This is known as a recess. The chair will usually announce at the beginning of the hearing what they plan on accomplishing before and after the recess. After a recess, the hearing picks up where it left off.

At the end, the chair will declare the hearing adjourned.
...
- Consideration of a bill starts with the chair **laying out** the bill and allowing the author or sponsor to explain it.
...
- A committee chair can **pigeonhole** a bill by refusing to schedule a hearing or a vote. This tactic is used to try to kill a bill.
...
At some point, the chair will call you by name to testify. At that point, hand your written testimony (if any) to the assistant clerk, then sit down at the table or stand behind the podium. Don't speak until the chair tells you to start. (At large hearings, you might be called twice: once to walk to the hearing site if you're in an overflow room, and the next time to actually testify.) If you're not there when called, you might be skipped, so be careful (the chair might call your name again a few minutes later if they skip you the first time). Keep in mind that you might be seated in a panel with multiple witnesses, whom you usually won't know. You'll speak one at a time.
...
There are some **behavioral norms** to follow&mdash;they're not rules, but following them will make you look more authoritative:

- Don't directly address anyone other than the chair (or, during questions, the person who asked you the question). Refer to them in the third person ("Senator Smith says", not "Senator Smith, you said"). This is designed to make it harder to get into heated arguments.
...
**Time limits** are strictly enforced. If the timer goes off, you can usually finish your sentence or your thought. Going beyond that will just make the chair mad at you and take time away from others who also want to testify.

After you testify, thank the chair and stay at the table or podium. The chair will ask committe members if they have any **questions**. Answer them honestly and as well as you can. It's OK if you don't know the answer to something. If a legislator asks you a question you don't know, you can optionally offer to look it up after the hearing and contact their office with your results. If you do make such a commitment, follow through as soon as possible.

Once the chair dismisses you, it's polite to thank them (though you can skip this if you're on a panel). Then just leave the table or podium.
